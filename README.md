...
- Figure out how to store larger files in the repo (maps, modpacks, tiles) <a href="https://docs.github.com/en/repositories/working-with-files/managing-large-files/about-large-files-on-github">Start Here</a>
